...
class Model extends sequelize_1.Model {
    constructor(values, options) {
      ...
      if (!target.isInitialized) {
            throw new model_not_initialized_error_1.ModelNotInitializedError(target, `${target.name} cannot be instantiated.`);
        }
        super(values, alias_inference_service_1.inferAlias(options, target));
    }
